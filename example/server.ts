...
// Initialize prototype-annotator middleware
      ...
      <main class="container">
        ...
        <section class="features">
          ...
          <div class="feature">
            ...
            <p>Generate structured prompts from your annotations, optionally enhanced with Ollama.</p>
          </div>
        </section>
      ...
      <div class="container">
        ...
        <div class="card">
          ...
          <ul style="padding-left: 20px; color: #666;">
            ...
            <li>AI-powered prompt generation with Ollama</li>
          </ul>
        </div>
